            ...
            <div class="col-lg-9">
                ...
                <?php foreach($data['productos'] as $producto) { ?>
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <a href="shop-single.html" class="h3 text-decoration-none"><?php echo $producto['pro_nombre'];?></a>
                ...
                <div div="row">
                    ...
                    if ($data['pagina']>1 ){
                       ...
                       <a class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0" href="'.$anterior.'">Anterior</a>
                   </li>';
                    }
                    if ($data['total']>=$siguiente) {
                        echo '<li class="page-item">
                        <a class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark" href="'.$siguiente.'">Siguiente</a>
                    </li>'; # code...
                    }
                    ?>
